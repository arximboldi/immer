...
#include <immer/extra/archive/cereal/immer_map.hpp>
...
template <>
struct hash<immer::archive::rbts::rbts_info>
{
    auto operator()(const immer::archive::rbts::rbts_info& x) const
    {
        ...
        boost_combine(seed,
                      hash<immer::archive::node_id::rep_t>{}(x.root.value));
        boost_combine(seed,
                      hash<immer::archive::node_id::rep_t>{}(x.tail.value));
        return seed;
    }
};
