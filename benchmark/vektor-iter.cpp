...
NONIUS_BENCHMARK("immu::vektor/4B/reduce",   reduce_generic<immu::vektor<unsigned,4>>())
NONIUS_BENCHMARK("immu::vektor/5B/reduce",   reduce_generic<immu::vektor<unsigned,5>>())
NONIUS_BENCHMARK("immu::vektor/6B/reduce",   reduce_generic<immu::vektor<unsigned,6>>())
